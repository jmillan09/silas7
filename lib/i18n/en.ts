/**
 * English dictionary — ported 1:1 from the original js/translations.js.
 * Values may contain inline HTML (spans, br, entities) and are rendered via dangerouslySetInnerHTML.
 */
export const en = {
  /* Navigation */
  'nav.home': 'Home',
  ...
  'ctc.breadcrumb': 'Contact',
  'ctc.ph-title': 'Get in <span style="color:var(--blue);">Touch</span>',
  'ctc.ph-desc':
    'Silas Seve<span style="color:#bd0016;">7</span>n Holdings Corp is available to address your requirements with speed, precision and professionalism.',

  /* Contacto — Info cards */
  'ctc.card1-label': 'Address',
  'ctc.card1-value': 'E 2nd St, Ste 7000<br>Casper, WY, United States',
  'ctc.card2-label': 'Email',
  'ctc.card2-value': 'info@silas7.com',
  'ctc.card3-label': 'Website',
